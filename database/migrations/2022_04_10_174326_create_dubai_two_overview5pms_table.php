...
class CreateDubaiTwoOverview5pmsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('dubai_two_overview5pms', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('dubai_two_overview5pms');
    }
}
