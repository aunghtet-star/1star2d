...
class CreateDubaiTwoOverview9pmsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('dubai_two_overview9pms', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('dubai_two_overview9pms');
    }
}
