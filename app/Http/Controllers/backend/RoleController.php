...
class RoleController extends Controller
{
    ...
    {
        PermissionChecker::CheckPermission('view_role');
        $roles = Role::all();
    ...
    {
        PermissionChecker::CheckPermission('create_role');
