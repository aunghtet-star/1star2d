...
class TwoController extends Controller
{
    ...
    public function twoHistoryAM(Request $request)
    {
        ...
        return view('backend.two_overview.am_history', compact('two_transactions', 'two_transactions_total', 'date', 'two_brake'));
    }
    ...
    public function twoHistoryPM(Request $request)
    {
        ...
        return view('backend.two_overview.pm_history', compact('two_transactions', 'two_transactions_total', 'date', 'two_brake'));
    }
