        ...
        <div class="col-md-8">
            ...
            <div class="card">
                <div class="d-flex justify-content-between">
                    <h5 class="" style="margin-top: 16px; margin-left:23px">Dubai 2D ထိုးရန်</h5>
                ...
                <div class="card-body">
                    <form id="validate" action="{{url('dubai-two/confirm')}}" method="POST" id="">
                        @csrf
                        <div class="row" >
                            <div class="col-3">
