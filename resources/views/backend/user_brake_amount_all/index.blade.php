...
<div class="app-main__inner">
    ...
    <a href="{{url('admin/user_brake_amount_all/create')}}" class="btn btn-success mb-3 ml-3"><i class="fas fa-circle-plus"></i>
        Create</a>
...
<script>
    $(document).ready(function() {
            var table = $('#two-table').DataTable({
                        "processing": true,
                        "serverSide": true,
                        "ajax": "/admin/user_brake_amount_all/datatables/ssd",
                        "columns" : [
                            {
                                data : "type",
                                name : "type",
                    ...
                    $(document).on('click','#delete',function(e){
                        ...
                        const swalWithBootstrapButtons = Swal.mixin({
                                ...
                                if (result.isConfirmed) {
                                    $.ajax({
                                        url : "/admin/user_brake_amount_all/"+id,
                                        type : "DELETE",
                                        success : function(){
                                            table.ajax.reload();
                                        }
