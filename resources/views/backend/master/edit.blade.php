...
<div class="app-main__inner">
    ...
    <div class="container">
        <div class="card">
            <div class="card-body">
                <form action="{{route('master.update',$master->id)}}" method="POST" id="update">
                    @csrf
                    @method('PATCH')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="phone" value="{{ $master->phone }}"
                            class="form-control">
                    </div>
...
@endsection
@section('scripts')
{!! JsValidator::formRequest('App\Http\Requests\UpdateMaster','#update') !!}
