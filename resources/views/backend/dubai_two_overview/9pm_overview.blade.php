...
@section('dubai-2D-overview-9pm','mm-active')
@section('extra_css')
    <style>
        .column {
            display: flex;
        ...
        <div class="app-page-title">
            <div class="page-title-wrapper">
                <div class="page-title-heading">
                    ...
                    <div>Dubai 2D Overview Dashboard 9PM
                ...
                <div class="card overview">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <a href="#" class="btn btn-dark" onclick="kyonAmount_9pm()">Clear</a>
                        </div>
                    </div>
                </div>
            </div>
...
@section('scripts')
    <script>
        ...
        function newAmount(id){
            ...
            $.ajax({
                url : `/admin/dubai-two-overview-9pm/new_amount/${date}/${id}`,
                method : 'post',
                data : {
