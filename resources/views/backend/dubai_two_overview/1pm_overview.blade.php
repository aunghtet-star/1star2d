...
@section('dubai-2D-overview-1pm','mm-active')
@section('extra_css')
<style>
    .column {
      display: flex;
                ...
                <div class="card-body">
                    @if ($two_overviews)
                            <div class="column">
                                @foreach ($two_overviews as $two_overview)
                                    <div class="d-flex" style="width:100px">
                                        ...
                                        <a href="{{ url('admin/dubai-twopout-1pm/' . $two_overview->two . '/' . $date) }}"><span><i
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <a href="#" class="btn btn-dark" onclick="kyonAmount_1pm()">Clear</a>
                        </div>
                </div>
            </div>
        </div>
    ...
    $(document).ready(function() {
        ...
        $('.date').daterangepicker({
                ...
                function newAmount(id){
                        ...
                        $.ajax({
                            url : `/admin/dubai-two-overview-1pm/new_amount/${date}/${id}`,
                            method : 'post',
                            data : {
                    ...
                    function kyonAmount_1pm(){

                    var date = $('.date').val() ?? moment('YYYY-MM-DD');

                    $.ajax({
                        url : '/admin/kyon_amount_1pm',
                        method : 'post',
                        data : {
                            date : date
                        },
