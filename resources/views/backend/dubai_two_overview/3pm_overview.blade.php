...
@section('dubai-2D-overview-3pm','mm-active')
@section('extra_css')
    <style>
        .column {
            display: flex;
        ...
        <div class="app-page-title">
            <div class="page-title-wrapper">
                <div class="page-title-heading">
                    ...
                    <div>Dubai 2D Overview Dashboard 3PM
                ...
                <div class="card overview">
                    <div class="card-body">
                            ...
                            <div class="column">
                                @foreach ($two_overviews as $two_overview)
                                    <div class="d-flex" style="width:100px">
                                        ...
                                        <a href="{{ url('admin/dubai-twopout-3pm/' . $two_overview->two . '/' . $date) }}"><span><i
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <a href="#" class="btn btn-dark" onclick="kyonAmount_3pm()">Clear</a>
                        </div>
                    </div>
                </div>
            </div>
...
@section('scripts')
    <script>
        ...
        function newAmount(id){
            ...
            $.ajax({
                url : `/admin/dubai-two-overview-3pm/new_amount/${date}/${id}`,
                method : 'post',
                data : {
        ...
        function kyonAmount_3pm(){

            var date = $('.date').val() ?? moment('YYYY-MM-DD');

            $.ajax({
                url : '/admin/kyon_amount_3pm',
                method : 'post',
                data : {
                    date : date
                },
