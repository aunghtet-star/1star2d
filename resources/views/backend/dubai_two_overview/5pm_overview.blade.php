        ...
        <div class="app-page-title">
            <div class="page-title-wrapper">
                <div class="page-title-heading">
                    ...
                    <div>Dubai 2D Overview Dashboard 5PM
                ...
                <div class="card overview">
                    <div class="card-body">
                            ...
                            <div class="column">
                                @foreach ($two_overviews as $two_overview)
                                    <div class="d-flex" style="width:100px">
                                        ...
                                        <a href="{{ url('admin/dubai-twopout-5pm/' . $two_overview->two . '/' . $date) }}"><span><i
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <a href="#" class="btn btn-dark" onclick="kyonAmount_5pm()">Clear</a>
                        </div>
                    </div>
                </div>
            </div>
...
@section('scripts')
    <script>
        ...
        function newAmount(id){
            ...
            $.ajax({
                url : `/admin/dubai-two-overview-5pm/new_amount/${date}/${id}`,
                method : 'post',
                data : {
        ...
        function kyonAmount_5pm(){

            var date = $('.date').val() ?? moment('YYYY-MM-DD');

            $.ajax({
                url : '/admin/kyon_amount_5pm',
                method : 'post',
                data : {
                    date : date
                },
