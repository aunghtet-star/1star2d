...
@section('2D-over-history-am','mm-active')
@section('extra_css')
<style>
    .column {
      display: flex;
                ...
                <div class="card-body">
                    ...
                    <div class="column" >
                        ...
                        <div class="d-flex" style="width:100px">
                            <p class="mb-2 mr-3 ">{{$two_transaction->two}} </p> => <span class="ml-2 @if(($two_brake->amount ?? 999999999999999999999999) < $two_transaction->total)  text-danger @endif">{{number_format($two_transaction->total)}}</span>
